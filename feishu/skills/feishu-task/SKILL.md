...
|---------|------|--------|---------|---------|---------|
| 新建待办 | `create_task` | summary | current_user_id（SenderId） | members, due, description |
| 查未完成任务 | `list_tasks` | - | completed=false | page_size |
| 获取任务详情 | `get_task` | task_guid | - | - |
| 完成任务 | `update_task` | task_guid, completed_at | - | - |
| 反完成任务 | `update_task` | task_guid, completed_at="0" | - | - |
| 改截止时间 | `update_task` | task_guid, due | - | - |
| 创建清单 | `create_tasklist` | name | - | members |
| 查看清单任务 | `list_tasklist_tasks` | tasklist_guid | - | completed |
| 添加清单成员 | `add_tasklist_members` | tasklist_guid, members[] | - | - |
